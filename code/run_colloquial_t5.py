...
if __name__ == "__main__":
    ...
    # TRANSFORMERS_OFFILNE=1 CUDA_VISIBLE_DEVICES=1 python run_colloquial_t5.py --do_train --do_eval
    # TRANSFORMERS_OFFILNE=1 CUDA_VISIBLE_DEVICES=1 nohup python -u run_colloquial_t5.py --do_train --do_eval --load_dir ./outputs_colloquial_t5/saved_model > colloquial_log_t5.file 2>&1 &
    # TRANSFORMERS_OFFILNE=1 CUDA_VISIBLE_DEVICES=1 nohup python -u run_colloquial_t5.py --do_test --load_dir ./outputs_colloquial_t5/saved_model > colloquial_log_t5.file 2>&1 &