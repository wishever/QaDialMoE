...
if __name__ == "__main__":
    ...
    # TRANSFORMERS_OFFILNE=1 python run_healthmoe.py --do_train --do_eval
    # TRANSFORMERS_OFFILNE=1 CUDA_VISIBLE_DEVICES=3 nohup python -u run_healthmoe.py --do_train --do_eval > health_log.file 2>&1 &
    # TRANSFORMERS_OFFILNE=1 CUDA_VISIBLE_DEVICES=1 nohup python -urun_healthmoe.py --do_eval --do_test --load_dir ./outputs_dialmoe_2/saved_model > out_71.3.file 2>&1 &