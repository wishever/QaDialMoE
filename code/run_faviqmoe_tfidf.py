...
class DataProcessor(object):
    ...
    def _create_examples(self, lines, max_evidences=3):
        ...
        for i, datapoint in enumerate(tqdm(lines)):
            if 'tfidf_evidence' in datapoint.keys():
                ...
                all_evidences = datapoint['tfidf_evidence'][:max_evidences]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", help="path to data", default='../data/faviq/tfidf/faviq_a_set,../data/faviq/tfidf/faviq_r_set') # 
    ...
    parser.add_argument("--output_dir", default='./outputs_faviqmoe_tfidf')
    ...
    # TRANSFORMERS_OFFILNE=1 CUDA_VISIBLE_DEVICES=2 nohup python -u run_faviqmoe_tfidf.py --do_train --do_eval --load_dir outputs_faviqmoe_tfidf/saved_model > faviq_log_tfidf.file 2>&1 &
